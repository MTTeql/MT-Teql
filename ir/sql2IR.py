# The program is adapted from https://github.com/microsoft/IRNet/blob/master/preprocess/sql2SemQL.py
...
import copy
try:
    from semQL import Root1, Root, N, A, C, T, Sel, Sup, Filter, Order
except:
    from ir.semQL import Root1, Root, N, A, C, T, Sel, Sup, Filter, Order
...
if __name__ == '__main__':
    sql = "SELECT AVG(age), year FROM CAR_DATA GROUP BY year"
    
    parser = Parser()

    print(parser.full_parse(sql))
